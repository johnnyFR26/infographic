...
interface Policy {
  ...
  cardPlus: ReactNode
  cardGridNumber: string[]
  cardGridLabel: string[]
  icon: string
  description: string
  examples: string[]
            ...
            <Card className={`relative overflow-hidden ${isActive ? "animate-pulse-glow" : ""}`}>
              ...
              <CardContent className="p-8">
                <div className="space-y-6">
                  <h3 className="text-2xl font-semibold text-primary"> {policy.cardTitle}</h3>
                  <p className="text-xl text-muted-foreground text-pretty"> {policy.cardDescription}</p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {policy.cardGridNumber.map((gridItem, gridItemIndex) => (
                      <div className="text-center p-4 bg-muted rounded-lg" key={gridItemIndex}>
                        <div className="text-3xl font-bold text-primary">{gridItem}</div>
                        <div className="text-sm text-muted-foreground">{policy.cardGridLabel[gridItemIndex]}</div>
                      </div>
                    ))}
                  </div>
